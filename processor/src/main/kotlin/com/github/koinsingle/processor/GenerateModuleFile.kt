...
class GenerateModuleFile(
    ...
    fun generate(elements: List<Element>) {
        ...
        val moduleCodeBlock = generateModuleCodeBlock(elements)
    ...
    private fun generateModuleCodeBlock(elements: List<Element>) : CodeBlock {
    ...
    private fun addSingle(generatedModulesBuilder: CodeBlock.Builder, annotatedElement: Element) {
